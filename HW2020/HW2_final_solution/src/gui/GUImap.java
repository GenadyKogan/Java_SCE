...
public class GUImap extends JPanel {
    ...
    public GUImap(ArrayList<Junction> junctions2,ArrayList<Vehicle> vehicles2){

        junctions = junctions2;
        vehicles = vehicles2;
        clr1  = new Color(0, 0, 255);
        for (int i = 0;i<junctions.size();i++){
            //drivermap.getJunctions().get(i).getX();
            //drivermap.getJunctions().get(i).getY();
    ...
    /*
    public GUImap(ArrayList<Junction> junctions2) {
        junctions = junctions2;
    }
    */
